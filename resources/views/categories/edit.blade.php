                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{route('categories.update', $category->id)}}" method="post">
                        ...
                        <p class="mb-6">
                            ...
                            <input id="name" name="name" type="text" class="border p-3 w-full"
                                   value="{{$category->name}}">
                        ...
                        <p class="mb-6">
                            ...
                            <input id="min_age" name="min_age" type="number" class="border p-3 w-full"
                        ...
                        <button type="submit" class="py-3 px-6 bg-gray-800 text-white mt-4">Submit</button>
                    </form>
                </div>
            </div>
        </div>
